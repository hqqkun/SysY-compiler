...
public:
  ...
  bool isGlobalVar() const { return kind == DeclKind::kGariable; }

protected:
  enum class DeclKind { kInvalid, kFunction, kGariable };
...
public:
  explicit GlobalVarDecl(IRContext &context, const std::string &name = "",
      ...
      : Declaration(name, DeclKind::kGariable), allocation(alloc) {}
